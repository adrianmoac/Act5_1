...
export default App = () => {
  ...
  channel.on("setIndiglo", (_payload) => setIndiglo("green"));
  ...
  return (
    <svg width="250" height="250">
      ...
      <rect
        onMouseDown={(e) => handleEvent("top-left-pressed")}
      ...
      />
      <rect
        onMouseDown={(e) => handleEvent("bottom-left-pressed")}
      ...
      />
      <rect
        onMouseDown={(e) => handleEvent("top-right-pressed")}
      ...
      />
      <rect
        onMouseDown={(e) => handleEvent("bottom-right-pressed")}
